...
#[derive(Template)]
#[template(path = "admin/admin_sanitizer.html")]
...
async fn sanitizer_page(State(state): State<AppState>, account: Account) -> Result<AdminSanitizerTemplate, StatusCode> {
